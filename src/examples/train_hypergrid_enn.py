...
from algos.ENN_GFN import MLP_ENN
...
def main(args):  # noqa: C901
    ...
    for iteration in pbar:
        ...
        if my_rank == 0:
            ...
            if log_this_iter:
                ...
                if iteration % 100 == 0:
                    l1_distance_enn.append((iteration, validation_info["l1_dist"], validation_info["n_modes_found"]))
    ...
    import csv
    with open("l1_distance_enn.csv", "w", newline="") as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(["iteration", "l1_distance", "n_modes_found"])
        writer.writerows(l1_distance_enn)
    try:
