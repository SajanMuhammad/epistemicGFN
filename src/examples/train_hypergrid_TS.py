...
from algos.TS_GFN import MLP
from gfn.utils.modules_TS_dropout import MLP_Dr
...
def main(args):  # noqa: C901
    ...
    for iteration in pbar:
        ...
        if my_rank == 0:
            ...
            if log_this_iter:
                ...
                if iteration % 100 == 0:
                    l1_distance_tsgfn.append((iteration, validation_info["l1_dist"], validation_info["n_modes_found"]))
                if use_wandb:
    ...
    import csv
    with open("l1_distance_tsgfn.csv", "w", newline="") as csvfile:
        writer = csv.writer(csvfile)
        writer.writerow(["iteration", "l1_distance", "n_modes_found"])
        writer.writerows(l1_distance_tsgfn)
